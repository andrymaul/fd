            ...
            <div className="lg:col-span-5 text-left space-y-5">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2">
                <button
                  ...
                  title="Masuk ke Sistem • Modul Cek Interaksi Obat (DDI)"
                ...
                >
                  <span>{currentUser ? 'Masuk Cek Interaksi Obat' : 'Coba Simulasi Klinis Gratis'}</span>
                ...
                <button
                  ...
                  title="Masuk ke Sistem • Dashboard 26 Modul Terpadu"
                ...
                >
                  ...
                  <span>{currentUser ? 'Masuk ke Dashboard (26 Modul)' : 'Eksplorasi 26 Modul Terpadu'}</span>
                </button>
              </div>
                  ...
                  <div className="p-4 sm:p-5 space-y-4 text-left font-sans">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-2 pt-2 border-t border-slate-100 text-[10.5px]">
                      ...
                      <button
                        type="button"
                        onClick={() => onSelectTab('interactions')}
                        title="Masuk Langsung ke Cek Interaksi Klinis"
