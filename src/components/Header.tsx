          ...
          <div className={`rounded-full transition-all duration-300 px-3.5 sm:px-5 py-2 sm:py-2.5 flex items-center justify-between gap-3 ${
            ...
            <div className="flex items-center space-x-2 shrink-0">
              ...
              <a
                ...
                className={`h-8 px-3 sm:px-3.5 rounded-full text-xs font-bold transition-all flex items-center justify-center gap-1.5 whitespace-nowrap cursor-pointer shadow-2xs hover:scale-[1.02] active:scale-95 font-outfit ${
                  activeTab === 'pricing'
                    ? 'bg-teal-600 text-white shadow-sm shadow-teal-600/30'
                    : 'text-slate-700 hover:text-teal-900 bg-white hover:bg-teal-50/80 border border-slate-200/90 hover:border-teal-300'
                }`}
              >
                <CreditCard className={`w-3.5 h-3.5 shrink-0 ${activeTab === 'pricing' ? 'text-teal-100' : 'text-teal-600'}`} />
                <span>Pricing</span>
              </a>
