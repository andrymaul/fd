    ...
    <div className="space-y-8 pb-16">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#02131b] via-[#052331] to-[#09374d] p-6 sm:p-8 text-white shadow-2xl border border-teal-500/25">
        ...
        <div className="relative z-10">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-6">
            <div className="space-y-3 max-w-2xl">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-teal-500/20 text-teal-300 border border-teal-500/30 text-xs font-bold font-outfit">
                ...
                <span>Program Pengendalian Resistensi Antimikroba (PPRA / AMS)</span>
              </div>
          ...
          <div className="flex flex-wrap gap-2 border-t border-teal-500/20 pt-4">
            {[
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2.5 rounded-2xl text-xs font-bold font-outfit transition-all cursor-pointer ${
                    isActive
                      ? 'bg-gradient-to-r from-teal-500 to-emerald-600 text-white shadow-lg shadow-teal-950/40 ring-2 ring-teal-400/40'
                      : 'bg-white/5 hover:bg-white/10 text-teal-200 border border-white/10'
                  }`}
                >
