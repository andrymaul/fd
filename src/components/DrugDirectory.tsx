          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2 flex-wrap">
              <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[11px] font-bold bg-teal-50 dark:bg-teal-950/60 text-[#005f5a] dark:text-teal-300 border border-teal-200/80 dark:border-teal-800/60">
                ...
                Standar Kompendia BPOM RI, FORNAS &amp; FDA
              </span>
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300">
                Monografi Lengkap, Restriksi &amp; Off-Label
              </span>
            </div>
            ...
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-teal-50 dark:bg-teal-950/50 text-[#005f5a] dark:text-teal-300 flex items-center justify-center border border-teal-200/60 dark:border-teal-800/60 shrink-0">
                <Pill className="w-5 h-5 text-[#005f5a] dark:text-teal-400" />
              </div>
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">
                  Basis data monografi obat, klasifikasi terapi ATC, ketentuan restriksi FORNAS, dan referensi off-label terverifikasi.
                </p>
              </div>
            </div>
          </div>

          {/* Quick Badges & Admin Action */}
          <div className="flex items-center gap-3 flex-wrap lg:justify-end">
            <div className="flex items-center gap-2">
              <div className="px-3 py-1.5 rounded-xl bg-slate-50 dark:bg-slate-850 border border-slate-200 dark:border-slate-800 text-left">
                <div className="text-[10px] text-slate-400 font-medium">Total Obat</div>
                <div className="text-xs font-bold font-mono text-slate-800 dark:text-slate-200">
                  {cleanDrugs.length.toLocaleString('id-ID')} Entitas
                </div>
              </div>
              <div className="px-3 py-1.5 rounded-xl bg-slate-50 dark:bg-slate-850 border border-slate-200 dark:border-slate-800 text-left">
                <div className="text-[10px] text-slate-400 font-medium">Kategori ATC</div>
                <div className="text-xs font-bold font-mono text-slate-800 dark:text-slate-200">
                  {DDINTER_CATEGORIES.length - 1} Golongan
                </div>
              </div>
            </div>
            ...
            {currentUser?.role === 'admin' && onOpenAddDrugModal && (
              <button
                ...
                className="px-3.5 py-2 rounded-xl bg-[#005f5a] text-white hover:bg-teal-700 text-xs font-bold font-outfit flex items-center gap-1.5 shadow-2xs cursor-pointer transition"
              >
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 text-xs font-bold font-outfit text-slate-900 dark:text-white bg-slate-50 dark:bg-slate-950 rounded-xl border border-slate-200 dark:border-slate-800 focus:outline-none focus:border-[#005f5a] focus:ring-2 focus:ring-[#005f5a]/30 transition-colors"
            />
          </div>
