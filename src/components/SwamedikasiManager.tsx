  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-200 print:max-w-none print:w-full print:m-0 print:p-0">
      ...
      <div className="space-y-6 pb-16 print:hidden">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2 flex-wrap">
                {onSelectTab && (
                  <button
                    ...
                    className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 text-[11px] font-bold transition-all cursor-pointer font-outfit"
                  >
                ...
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300">
                  Permenkes No. 28/2022 &amp; W-H-A-M Triage
                </span>
              </div>
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-teal-50 dark:bg-teal-950/50 text-[#005f5a] dark:text-teal-300 flex items-center justify-center border border-teal-200/60 dark:border-teal-800/60 shrink-0">
                  <Sparkles className="w-5 h-5 text-[#005f5a] dark:text-teal-400" />
                </div>
                <div>
                  <h1 className="text-xl sm:text-2xl font-bold font-outfit text-slate-900 dark:text-white tracking-tight">
                    Swamedikasi &amp; Triage Keluhan Klinis
                  </h1>
                  <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">
                    Protokol penanganan mandiri keluhan umum, algoritma rujukan medis (red flags), dan edukasi pemilihan obat bebas/terbatas.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 flex-wrap lg:justify-end">
              <div className="flex items-center gap-2">
                <div className="px-3 py-1.5 rounded-xl bg-slate-50 dark:bg-slate-850 border border-slate-200 dark:border-slate-800 text-left">
                  <div className="text-[10px] text-slate-400 font-medium">Total Protokol</div>
                  <div className="text-xs font-bold font-mono text-slate-800 dark:text-slate-200">
                    {SWAMEDIKASI_PROTOCOLS.length} Keluhan
                  </div>
                </div>
                <div className="px-3 py-1.5 rounded-xl bg-slate-50 dark:bg-slate-850 border border-slate-200 dark:border-slate-800 text-left">
                  <div className="text-[10px] text-slate-400 font-medium">Algoritma Triage</div>
                  <div className="text-xs font-bold font-mono text-slate-800 dark:text-slate-200">
                    W-H-A-M &amp; Red Flags
                  </div>
                </div>
              ...
              >
                ...
                <span>Cetak Ringkasan Triage</span>
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-[#0c1427] p-5 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-2xs space-y-4">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-2.5 text-xs font-bold font-outfit text-slate-900 dark:text-white bg-slate-50 dark:bg-slate-950 rounded-xl border border-slate-200 dark:border-slate-800 focus:outline-none focus:border-[#005f5a] focus:ring-2 focus:ring-[#005f5a]/30 transition-colors"
              />
            {searchQuery && (
              <button
