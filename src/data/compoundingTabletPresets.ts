...
export interface CompoundingTabletPreset {
  ...
  doseUnit?: string;
  notes?: string;
  doNotCrush?: boolean; // Peringatan sediaan tidak boleh digerus
  crushWarning?: string; // Penjelasan klinis alasan larangan gerus
}
...
export const COMPOUNDING_TABLET_PRESETS: CompoundingTabletPreset[] = [
  ...
  },
  {
    ...
    notes: 'Tablet enteric coated (salut enterik).',
    doNotCrush: true,
    crushWarning: 'Tablet Salut Enterik: Menggerus merusak lapisan tahan asam dan memicu iritasi/perdarahan lambung berat.'
  },
  {
  ...
  // =====================================================================
  // 10. EKSPANSI PRESET TABLET PUYER SPESIALISTIK (PEDIATRIK & KLINIS)
  // =====================================================================
  {
    id: 'comp-preset-levetiracetam',
    name: 'Levetiracetam Tablet',
    genericName: 'Levetiracetam',
    brandSynonyms: ['Keppra', 'Letiram', 'Levina', 'Epilep'],
    category: 'Antikonvulsan / Anti-Epilepsi Anak',
    defaultStrengthMg: 250,
    availableStrengthsMg: [250, 500],
    standardTabletWeightMg: 350,
    pediatricDoseMgPerKgPerDose: 15,
    pediatricDoseRangeLabel: '10 - 30 mg/kg/kali (2x sehari)',
    notes: 'Tablet salut selaput 250 mg & 500 mg. Dosis anak 20-60 mg/kg/hari terbagi 2 dosis.'
  },
  {
    id: 'comp-preset-topiramate',
    name: 'Topiramate Tablet',
    genericName: 'Topiramate',
    brandSynonyms: ['Topamax'],
    category: 'Antikonvulsan / Profilaksis Migrain',
    defaultStrengthMg: 25,
    availableStrengthsMg: [25, 50, 100],
    standardTabletWeightMg: 150,
    pediatricDoseMgPerKgPerDose: 1.5,
    pediatricDoseRangeLabel: '1 - 3 mg/kg/kali (2x sehari)',
    notes: 'Tablet salut selaput 25 mg dan 50 mg. Mulai dari dosis titrasi rendah.'
  },
  {
    id: 'comp-preset-levothyroxine',
    name: 'Levothyroxine (Euthyrox)',
    genericName: 'Levothyroxine Sodium',
    brandSynonyms: ['Euthyrox', 'Thyrax Duotab'],
    category: 'Hormon Tiroid / Hipotiroid Kongenital',
    defaultStrengthMg: 0.050,
    availableStrengthsMg: [0.025, 0.050, 0.100],
    standardTabletWeightMg: 100,
    pediatricDoseMgPerKgPerDose: 0.012,
    pediatricDoseRangeLabel: '10 - 15 mcg/kg/hari (1x sehari saat perut kosong)',
    doseUnit: 'mg (mcg)',
    notes: 'Tablet 25 mcg, 50 mcg, 100 mcg. Sangat krusial untuk terapi hipotiroid kongenital bayi.'
  },
  {
    id: 'comp-preset-baclofen',
    name: 'Baclofen Tablet',
    genericName: 'Baclofen',
    brandSynonyms: ['Lioresal'],
    category: 'Relaksan Otot / Spastisitas Cerebral Palsy',
    defaultStrengthMg: 10,
    availableStrengthsMg: [10],
    standardTabletWeightMg: 150,
    pediatricDoseMgPerKgPerDose: 0.25,
    pediatricDoseRangeLabel: '0.2 - 0.5 mg/kg/kali (3x sehari)',
    notes: 'Tablet 10 mg. Sering diracik puyer untuk relaksasi spastisitas pada anak cerebral palsy.'
  },
  {
    id: 'comp-preset-methotrexate',
    name: 'Methotrexate (MTX) Tablet',
    genericName: 'Methotrexate',
    brandSynonyms: ['Emthexate', 'Metotreksat'],
    category: 'Imunosupresan / Sitotoksik',
    defaultStrengthMg: 2.5,
    availableStrengthsMg: [2.5],
    standardTabletWeightMg: 100,
    pediatricDoseMgPerKgPerDose: 0.25,
    pediatricDoseRangeLabel: 'Diberikan MINGGUAN (Bukan harian!)',
    notes: 'Tablet 2.5 mg. Sitotoksik: Kenakan sarung tangan & masker saat pengerjaan. PERHATIAN: Dosis mingguan!'
  },
  {
    id: 'comp-preset-mercaptopurine',
    name: '6-Mercaptopurine (6-MP)',
    genericName: 'Mercaptopurine',
    brandSynonyms: ['Puri-Nethol'],
    category: 'Sitotoksik / Leukemia Limfoblastik Akut (ALL)',
    defaultStrengthMg: 50,
    availableStrengthsMg: [50],
    standardTabletWeightMg: 150,
    pediatricDoseMgPerKgPerDose: 1.5,
    pediatricDoseRangeLabel: '1.5 - 2.5 mg/kg/hari (1x sehari malam hari)',
    notes: 'Tablet 50 mg. Kemoterapi maintenance ALL anak. Gunakan APD saat meracik puyer.'
  },
  {
    id: 'comp-preset-hydroxyurea',
    name: 'Hydroxyurea Kapsul',
    genericName: 'Hydroxyurea',
    brandSynonyms: ['Hydrea', 'Cytodrox'],
    category: 'Antineoplastik / Talasemia & Sickle Cell',
    defaultStrengthMg: 500,
    availableStrengthsMg: [500],
    standardTabletWeightMg: 600,
    pediatricDoseMgPerKgPerDose: 15,
    pediatricDoseRangeLabel: '15 - 20 mg/kg/hari (1x sehari)',
    notes: 'Kapsul 500 mg. Meningkatkan sintesis hemoglobin F pada talasemia beta/anemia sel sabit.'
  },
  {
    id: 'comp-preset-enalapril',
    name: 'Enalapril Tablet',
    genericName: 'Enalapril Maleate',
    brandSynonyms: ['Tenace', 'Tenazide'],
    category: 'ACE Inhibitor / Antihipertensi & Jantung',
    defaultStrengthMg: 5,
    availableStrengthsMg: [5, 10],
    standardTabletWeightMg: 150,
    pediatricDoseMgPerKgPerDose: 0.1,
    pediatricDoseRangeLabel: '0.08 - 0.25 mg/kg/kali (1-2x sehari)',
    notes: 'Tablet 5 mg dan 10 mg. Alternatif Captopril dengan durasi kerja lebih panjang.'
  },
  {
    id: 'comp-preset-bisoprolol',
    name: 'Bisoprolol Tablet',
    genericName: 'Bisoprolol Fumarate',
    brandSynonyms: ['Concor', 'B-Beta', 'Bisovell', 'Maintate'],
    category: 'Beta-Blocker Kardioselektif (Beta-1)',
    defaultStrengthMg: 2.5,
    availableStrengthsMg: [1.25, 2.5, 5],
    standardTabletWeightMg: 100,
    pediatricDoseMgPerKgPerDose: 0.05,
    pediatricDoseRangeLabel: '0.05 - 0.1 mg/kg/hari (1x sehari pagi)',
    notes: 'Tablet 2.5 mg dan 5 mg. Gagal jantung kronis anak & kardiomiopati.'
  },
  {
    id: 'comp-preset-amlodipine',
    name: 'Amlodipine Tablet',
    genericName: 'Amlodipine Besilate',
    brandSynonyms: ['Norvask', 'Tensivask', 'Amdixal', 'Divask', 'Theravask'],
    category: 'Calcium Channel Blocker (CCB) Dihidropiridin',
    defaultStrengthMg: 5,
    availableStrengthsMg: [5, 10],
    standardTabletWeightMg: 150,
    pediatricDoseMgPerKgPerDose: 0.1,
    pediatricDoseRangeLabel: '0.05 - 0.15 mg/kg/kali (1x sehari)',
    notes: 'Tablet 5 mg dan 10 mg. Antihipertensi anak usia >6 tahun.'
  },
  {
    id: 'comp-preset-kcl',
    name: 'Kalium Klorida Lepas Lambat (KSR 600 mg)',
    genericName: 'Potassium Chloride (KCl SR)',
    brandSynonyms: ['KSR', 'Kalium Klorida'],
    category: 'Suplemen Elektrolit Lepas Lambat',
    defaultStrengthMg: 600,
    availableStrengthsMg: [600],
    standardTabletWeightMg: 750,
    pediatricDoseMgPerKgPerDose: 10,
    pediatricDoseRangeLabel: 'Gunakan larutan sirup oral jika untuk anak',
    notes: 'Tablet sustained-release (SR) 600 mg (8 mEq K+).',
    doNotCrush: true,
    crushWarning: 'Tablet Lepas Lambat (Sustained Release): Menggerus memicu pelepasan kalium dosis tinggi lokal (dose dumping) yang berisiko memicu ulserasi gastrointestinal berat. Gunakan sediaan cair/sirup.'
  },
  {
    id: 'comp-preset-bisacodyl',
    name: 'Bisacodyl Tablet (Dulcolax)',
    genericName: 'Bisacodyl Enteric Coated',
    brandSynonyms: ['Dulcolax', 'Custodiol'],
    category: 'Laksatif Stimulan / Konstipasi',
    defaultStrengthMg: 5,
    availableStrengthsMg: [5],
    standardTabletWeightMg: 100,
    pediatricDoseMgPerKgPerDose: 0.3,
    pediatricDoseRangeLabel: '5 mg (1 tablet utuh untuk anak >6 th)',
    notes: 'Tablet salut enterik 5 mg.',
    doNotCrush: true,
    crushWarning: 'Tablet Salut Enterik: Dilarang keras digerus! Menggerus lapisan pelindung menyebabkan pelepasan bisacodyl di lambung, memicu mual hebat, muntah, dan kram abdomen parah.'
  },
  {
    id: 'comp-preset-ferrous-sulfate',
    name: 'Sulfas Ferosus (Zat Besi)',
    genericName: 'Ferrous Sulfate Tablet',
    brandSynonyms: ['Sangobion', 'Ferro-Folat', 'Sulfas Ferosus Generik'],
    category: 'Antianemia Defisiensi Besi',
    defaultStrengthMg: 300,
    availableStrengthsMg: [200, 300],
    standardTabletWeightMg: 350,
    pediatricDoseMgPerKgPerDose: 3,
    pediatricDoseRangeLabel: '3 - 6 mg besi elemental/kg/hari',
    notes: 'Tablet salut gula 300 mg (~60 mg besi elemental). Diminum bersama vitamin C atau jus jeruk.'
  },
  {
    id: 'comp-preset-desloratadine',
    name: 'Desloratadine Tablet',
    genericName: 'Desloratadine',
    brandSynonyms: ['Aerius', 'Destavell', 'Deslodin'],
    category: 'Antihistamin H1 Non-Sedatif Generasi ke-2',
    defaultStrengthMg: 5,
    availableStrengthsMg: [5],
    standardTabletWeightMg: 120,
    pediatricDoseMgPerKgPerDose: 0.08,
    pediatricDoseRangeLabel: '1.25 - 2.5 mg per racikan (1x sehari)',
    notes: 'Tablet salut selaput 5 mg. Metabolit aktif loratadine, non-sedatif.'
  },
  {
    id: 'comp-preset-rupatadine',
    name: 'Rupatadine Tablet',
    genericName: 'Rupatadine Fumarate',
    brandSynonyms: ['Rupafin', 'Ryaltris Oral'],
    category: 'Antihistamin H1 & Antagonis PAF Generasi Baru',
    defaultStrengthMg: 10,
    availableStrengthsMg: [10],
    standardTabletWeightMg: 150,
    pediatricDoseMgPerKgPerDose: 0.15,
    pediatricDoseRangeLabel: '5 - 10 mg (1x sehari untuk anak >6 th)',
    notes: 'Tablet 10 mg. Ganda: menghambat reseptor histamin H1 dan platelet-activating factor (PAF).'
  },
  {
    id: 'comp-preset-azathioprine',
    name: 'Azathioprine Tablet',
    genericName: 'Azathioprine',
    brandSynonyms: ['Imuran'],
    category: 'Imunosupresan / Penyakit Autoimun Pediatrik',
    defaultStrengthMg: 50,
    availableStrengthsMg: [50],
    standardTabletWeightMg: 150,
    pediatricDoseMgPerKgPerDose: 1,
    pediatricDoseRangeLabel: '1 - 2.5 mg/kg/hari (1-2x sehari)',
    notes: 'Tablet 50 mg. Sindrom nefrotik resisten steroid, SLE anak, IBD. Berpotensi sitotoksik, kenakan sarung tangan.'
  },
  {
    id: 'comp-preset-clonidine',
    name: 'Clonidine Tablet (Catapres)',
    genericName: 'Clonidine HCl',
    brandSynonyms: ['Catapres'],
    category: 'Agonis Alfa-2 Sentral / Hipertensi & ADHD',
    defaultStrengthMg: 0.15,
    availableStrengthsMg: [0.075, 0.15],
    standardTabletWeightMg: 120,
    pediatricDoseMgPerKgPerDose: 0.002,
    pediatricDoseRangeLabel: '2 - 5 mcg/kg/kali (2-3x sehari)',
    doseUnit: 'mg (mcg)',
    notes: 'Tablet 0.15 mg (150 mcg) dan 0.075 mg (75 mcg). Dosis sangat kecil (mikrogram).'
  },
  {
    id: 'comp-preset-sucralfate-tab',
    name: 'Sukralfat Tablet',
    genericName: 'Sucralfate',
    brandSynonyms: ['Inpepsa', 'Ulsafate', 'Episan', 'Neciblok'],
    category: 'Mukoprotektor Lambung',
    defaultStrengthMg: 500,
    availableStrengthsMg: [500],
    standardTabletWeightMg: 650,
    pediatricDoseMgPerKgPerDose: 20,
    pediatricDoseRangeLabel: '40 - 80 mg/kg/hari terbagi 4 dosis (sebelum makan)',
    notes: 'Tablet 500 mg. Diminum 1 jam sebelum makan atau saat perut kosong.'
  },
  {
    id: 'comp-preset-oat-fdc-rhz',
    name: 'OAT KDT Anak RHZ (75/50/150 mg)',
    genericName: 'Rifampisin + INH + Pirazinamid Dispersible',
    brandSynonyms: ['OAT FDC Pediatrik Kemenkes RI', 'RHZ Anak'],
    category: 'OAT Lini Pertama Fase Intensif Anak (KDT)',
    defaultStrengthMg: 1,
    availableStrengthsMg: [1],
    standardTabletWeightMg: 400,
    pediatricDoseMgPerKgPerDose: 0.1,
    pediatricDoseRangeLabel: 'Sesuai BB: 5-9kg (1 tab), 10-14kg (2 tab), 15-19kg (3 tab), 20-32kg (4 tab)',
    doseUnit: 'tablet',
    notes: 'Tablet dispersibel: Larutkan dalam air/ASI. Fase intensif 2 bulan pertama.'
  },
  {
    id: 'comp-preset-oat-fdc-rh',
    name: 'OAT KDT Anak RH (75/50 mg)',
    genericName: 'Rifampisin + INH Dispersible',
    brandSynonyms: ['OAT FDC Pediatrik Lanjutan', 'RH Anak'],
    category: 'OAT Lini Pertama Fase Lanjutan Anak (KDT)',
    defaultStrengthMg: 1,
    availableStrengthsMg: [1],
    standardTabletWeightMg: 250,
    pediatricDoseMgPerKgPerDose: 0.1,
    pediatricDoseRangeLabel: 'Sesuai BB: 5-9kg (1 tab), 10-14kg (2 tab), 15-19kg (3 tab), 20-32kg (4 tab)',
    doseUnit: 'tablet',
    notes: 'Tablet dispersibel: Larutkan dalam air. Fase lanjutan 4 bulan pengobatan TB.'
  },
  {
    id: 'comp-preset-lorazepam',
    name: 'Lorazepam Tablet',
    genericName: 'Lorazepam',
    brandSynonyms: ['Ativan', 'Merlopam'],
    category: 'Benzodiazepin / Sedatif & Anti-Ansietas',
    defaultStrengthMg: 1,
    availableStrengthsMg: [0.5, 1, 2],
    standardTabletWeightMg: 120,
    pediatricDoseMgPerKgPerDose: 0.05,
    pediatricDoseRangeLabel: '0.02 - 0.05 mg/kg/kali (2-3x sehari p.r.n)',
    notes: 'Tablet 0.5 mg, 1 mg, dan 2 mg. Psikotropika Golongan IV.'
  },
  {
    id: 'comp-preset-midazolam-tab',
    name: 'Midazolam Tablet',
    genericName: 'Midazolam',
    brandSynonyms: ['Miloz', 'Sedacum Oral', 'Dormicum'],
    category: 'Benzodiazepin Onset Cepat / Premedikasi',
    defaultStrengthMg: 15,
    availableStrengthsMg: [7.5, 15],
    standardTabletWeightMg: 180,
    pediatricDoseMgPerKgPerDose: 0.3,
    pediatricDoseRangeLabel: '0.25 - 0.5 mg/kg dosis tunggal premedikasi',
    notes: 'Tablet 15 mg. Sering digunakan untuk premedikasi sedasi sadar sebelum prosedur medis anak.'
  },
  {
    id: 'comp-preset-gabapentin',
    name: 'Gabapentin Kapsul',
    genericName: 'Gabapentin',
    brandSynonyms: ['Neurontin', 'Alpentin', 'Sipentin', 'Nepatic'],
    category: 'Antikonvulsan / Nyeri Neuropatik Pediatrik',
    defaultStrengthMg: 300,
    availableStrengthsMg: [100, 300],
    standardTabletWeightMg: 400,
    pediatricDoseMgPerKgPerDose: 10,
    pediatricDoseRangeLabel: '5 - 15 mg/kg/kali (3x sehari)',
    notes: 'Kapsul 100 mg dan 300 mg. Dosis anak 15-35 mg/kg/hari terbagi 3 dosis.'
  },
  {
    id: 'comp-preset-pregabalin',
    name: 'Pregabalin Kapsul',
    genericName: 'Pregabalin',
    brandSynonyms: ['Lyrica', 'Prolin', 'Prebalin'],
    category: 'Antikonvulsan / Modulator Kanal Kalsium',
    defaultStrengthMg: 75,
    availableStrengthsMg: [50, 75, 150],
    standardTabletWeightMg: 200,
    pediatricDoseMgPerKgPerDose: 1.5,
    pediatricDoseRangeLabel: '1 - 3 mg/kg/kali (2x sehari)',
    notes: 'Kapsul 75 mg dan 150 mg. Dosis anak 2.5-10 mg/kg/hari.'
  },
  {
    id: 'comp-preset-allopurinol',
    name: 'Allopurinol Tablet',
    genericName: 'Allopurinol',
    brandSynonyms: ['Zyloric', 'Puricemia', 'Sinoric', 'Llanol'],
    category: 'Inhibitor Xantin Oksidase / Sindrom Lisis Tumor',
    defaultStrengthMg: 100,
    availableStrengthsMg: [100, 300],
    standardTabletWeightMg: 200,
    pediatricDoseMgPerKgPerDose: 3.5,
    pediatricDoseRangeLabel: '2.5 - 5 mg/kg/kali (3x sehari sesudah makan)',
    notes: 'Tablet 100 mg dan 300 mg. Pencegahan sindrom lisis tumor pada keganasan hematologi anak.'
  },
  {
    id: 'comp-preset-kolkisin',
    name: 'Kolkisin (Colchicine)',
    genericName: 'Colchicine',
    brandSynonyms: ['Recolfar', 'Licrox'],
    category: 'Antiinflamasi Spesifik / Familial Mediterranean Fever',
    defaultStrengthMg: 0.5,
    availableStrengthsMg: [0.5],
    standardTabletWeightMg: 100,
    pediatricDoseMgPerKgPerDose: 0.02,
    pediatricDoseRangeLabel: '0.5 - 1 mg/hari (1-2x sehari)',
    notes: 'Tablet 0.5 mg. Dosis sangat kecil; waspadai diare dan toksisitas GI.'
  },
  {
    id: 'comp-preset-thiamine',
    name: 'Vitamin B1 (Thiamine HCl)',
    genericName: 'Thiamine HCl Tablet',
    brandSynonyms: ['Vitamin B1 Generik'],
    category: 'Vitamin & Koenzim Metabolisme Karbohidrat',
    defaultStrengthMg: 50,
    availableStrengthsMg: [50, 100],
    standardTabletWeightMg: 120,
    pediatricDoseMgPerKgPerDose: 2,
    pediatricDoseRangeLabel: '10 - 50 mg/hari',
    notes: 'Tablet 50 mg. Beriberi, malnutrisi, asidosis metabolik.'
  },
  {
    id: 'comp-preset-piridoksin',
    name: 'Vitamin B6 (Pyridoxine HCl)',
    genericName: 'Pyridoxine HCl Tablet',
    brandSynonyms: ['Vitamin B6 Generik'],
    category: 'Vitamin / Pendamping Terapi INH OAT Anak',
    defaultStrengthMg: 10,
    availableStrengthsMg: [10, 25],
    standardTabletWeightMg: 100,
    pediatricDoseMgPerKgPerDose: 1,
    pediatricDoseRangeLabel: '5 - 10 mg/hari (dosis tunggal pagi)',
    notes: 'Tablet 10 mg. Pencegahan neuropati perifer pada terapi Isoniazid (INH).'
  },
  {
    id: 'comp-preset-zinc-eff',
    name: 'Zinc Dispersible Tablet 20 mg',
    genericName: 'Zinc Sulfate Dispersible',
    brandSynonyms: ['Zinkid', 'Orezinc', 'Daryazinc', 'Zincare'],
    category: 'Suplementasi Mineral Diare Akut IDAI',
    defaultStrengthMg: 20,
    availableStrengthsMg: [20],
    standardTabletWeightMg: 250,
    pediatricDoseMgPerKgPerDose: 2,
    pediatricDoseRangeLabel: 'Bayi <6 bln: 10 mg/hari; Anak >=6 bln: 20 mg/hari (selama 10 hari)',
    notes: 'Tablet dispersibel 20 mg. Dilarutkan dalam 1 sendok air/ASI. Wajib 10 hari penuh.'
  },
  {
    id: 'comp-preset-probiotic-sachet',
    name: 'Probiotik Sachet (L-Bio / Lacto-B)',
    genericName: 'Lactobacillus + Bifidobacterium',
    brandSynonyms: ['L-Bio', 'Lacto-B', 'Liprolac', 'Interlac Sachet'],
    category: 'Probiotik Saluran Cerna / Diare Pediatrik',
    defaultStrengthMg: 1000,
    availableStrengthsMg: [1000],
    standardTabletWeightMg: 1000,
    pediatricDoseMgPerKgPerDose: 50,
    pediatricDoseRangeLabel: '1 - 2 sachet sehari dicampur makanan/susu',
    doseUnit: 'sachet',
    notes: 'Serbuk sachet 1 gram. Jangan dicampur minuman panas.'
  },
  {
    id: 'comp-preset-oralit-sachet',
    name: 'Oralit Sachet Rendah Osmolaritas (WHO-ORS)',
    genericName: 'Oral Rehydration Salts 200 mL',
    brandSynonyms: ['Oralit Kimia Farma', 'Pharolit', 'Corsalit'],
    category: 'Rehidrasi Elektrolit Diare Akut IDAI',
    defaultStrengthMg: 4100,
    availableStrengthsMg: [4100],
    standardTabletWeightMg: 4100,
    pediatricDoseMgPerKgPerDose: 100,
    pediatricDoseRangeLabel: '10 mL/kg tiap BAB cair (atau 1/2 - 1 gelas)',
    doseUnit: 'sachet (200 mL)',
    notes: '1 sachet dilarutkan dalam 200 mL air matang. Standar formula WHO osmolaritas rendah.'
  }
];
